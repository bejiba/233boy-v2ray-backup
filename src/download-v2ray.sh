_get_latest_version() {
	v2ray_latest_ver="$(curl -H 'Cache-Control: no-cache' -s https://api.github.com/repos/v2fly/v2ray-core/releases/35948990 | grep 'tag_name' | cut -d\" -f4)"
...
_download_v2ray_file() {
	...
	v2ray_download_link="https://github.com/v2fly/v2ray-core/releases/download/v4.34.0/v2ray-linux-${v2ray_bit}.zip"
